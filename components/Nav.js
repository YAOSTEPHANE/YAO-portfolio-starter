...
export const navData = [
  ...
  { name: 'Travail', path: '/work', icon: <HiViewColumns /> },
  {
    name: 'Témoignages',
    path: '/testimonials',
  ...
  return (
    ...
    xl :max-w-md xl:h-screen'>
      ...
      <div className='flex w-full xl:flex-col items-center
       justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0
        h-[80px] xl:h-max py-8 bg-white/10 backdrop-blur-sm text-3xl

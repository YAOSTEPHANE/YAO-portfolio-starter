              ...
              return (
                ...
                justify-center group' key={index}>
                  <div className='flex items-center justify-center relative overflow-hidden'>
                    ...
                    via-[#4e4c4e] to-[#4a22bd] opacity-0 group-hover:opacity-80 transition-all
                    duration-700'></div>
                    {/* title */}
                    ...
                    <div className='flex items-center gap-x-2 text-[13px] tracking-[0.2em]'>
                      ...
                      {/* title part 2*/}
                       <div className='tranlate-y-[500%] group-hover:translate-y-0 transition-all duration-300 delay-150'>
                        PROJET
                      </div>
                      {/* icon */}

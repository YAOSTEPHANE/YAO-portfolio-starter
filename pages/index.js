...
const Home = () => {
  return <div className="bg-accent/60 h-full">
    {/* text */}
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      ...
      h-full container mx-auto">
        ...
        <motion.h1
          ...
          exit='hidden'
          className="h1">
          Cabinet de Formations étude <br />Et <span
        ...
        <motion.p
          ...
          le Cabinet YES Consulting est un Cabinet de
          Formation, Etudes et de développement des carrières.
        </motion.p>
        {/* btn */}
